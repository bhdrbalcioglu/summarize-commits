<template>
  <div class="p-8 bg-gray-50 min-h-screen">
    ...
    <div v-else class="mt-6">
      <DataTable :columns="columns" :data="groupStore.groups" @rowClick="navigateToGroupProjects" />
    </div>
  </div>
</template>
...
const navigateToGroupProjects = (group: { id: number | string; full_name: string }) => {
  router
    .push({
      name: 'ProjectsView',
      query: {
